...
export default function ConsultasAdm() {
    ...
    function listarPacientes() {
        //requisição mockada
        axios('https://6205067b161670001741b359.mockapi.io/consulta/1/paciente', 
    ...
    function listarMedicos() {
        //requisição mockada
        axios('https://6205067b161670001741b359.mockapi.io/consulta/1/medico', 
    ...
    function listarConsultas() {
        //requisição mockada
        axios('https://6205067b161670001741b359.mockapi.io/consulta', 
    ...
    function cadastrarConsulta(evento) {
        ...
        //requisição mockada
        axios.post('https://6205067b161670001741b359.mockapi.io/consulta', 
    ...
    function excluirConsulta(consulta){
        ...
        //requisição mockada
        axios.delete('https://6205067b161670001741b359.mockapi.io/consulta/' + consulta.idConsulta ,
